...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vee_validate__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate_dist_locale_en__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vee_validate_dist_locale_fr__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_menu__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_contact__ = __webpack_require__(51);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      isOpen: false,
      menu: [{ name: 'Accueil', url: 'top' }, { name: 'Services', url: 'services' }, { name: 'A propos', url: 'about' }, { name: 'Compétences', url: 'skills' }, { name: 'Contact', url: 'contact' }]
    };
  }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__captcha__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__messages__ = __webpack_require__(77);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_captcha__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__button__ = __webpack_require__(93);
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-54220920"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54220920", Component.options)
  } else {
    hotAPI.reload("data-v-54220920", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(5)("6b1346b2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../css-loader/index.js?sourceMap!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-54220920\",\"scoped\":true,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0!./vue-captcha.vue", function() {
     var newContent = require("!!../css-loader/index.js?sourceMap!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-54220920\",\"scoped\":true,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0!./vue-captcha.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_font_awesome_css_font_awesome_css__ = __webpack_require__(64);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	watch: {
		errorSelect: function errorSelect(error) {
			if (error > 0) {
				// console.error('[Vue-captcha] Try Errors: ', error)
			}
		},
		success: function success(acert) {
			if (acert === 6) {
				this.callSuccess();
			}
		}
	...
	methods: {
		getKey: function getKey() {
			...
			if (this.mode === 'text') {
				do {
					newKey = __WEBPACK_IMPORTED_MODULE_0_uuid___default()();
					newKey = newKey.replace('-', '');
					newKey = newKey.substr(5, 6);
				} while (this.codex(newKey));
				this.key = newKey;
		...
		picture: function picture() {
			var image = this.$el.children[0].children[0];
			...
			var left = this.mode === 'text' ? 35 : 32;
			ctx.fillText(this.getKey(), left, 22);
		},
		inputText: function inputText() {
			var text = this.mode === 'math' ? Number.parseInt(this.text) : this.text;
			if (this.key === text) {
				this.auth = true;
				this.success = 6;
			}
		},
		ContentFixed: function ContentFixed() {
			var el = this.$el;
			var _x = 0;
			var _y = 0;
		...
		operation: function operation() {
			...
			var b = Math.floor(Math.random() * max + 10);
			var o = Math.floor(Math.random() * 9 + 0);
			var cadena = a + ' + ' + b;
			var result = eval(cadena);

			/*** CONTROL ARRAY FOR RANDOM SELECT  ***/
			do {
				var pre = Math.floor(Math.random() * max + 10);
				if (pre !== result) {
					this.arrayForNum.push(pre);
				}
			} while (this.arrayForNum.length < 10);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-54220920", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "section",
    { staticClass: "d-flex justify-content-center", attrs: { id: "contact" } },
    [
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__loader__ = __webpack_require__(97);
          ...
          _c(
            ...
            [
              _c(
                "dd-button",
                {
                  attrs: { disabled: _vm.btndis, loading: _vm.loading },
                  on: {
                    click: function($event) {
                      _vm.contactMe()
                    }
